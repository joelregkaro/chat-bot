...
import { MessageSquare, Shield, Clock, Users, CheckCircle2 } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-4 py-2 bg-blue/10 rounded-full mb-6">
              <span className="text-blue font-medium text-sm">Expert Support Available 24/7</span>
            </div>
            <h2 className="text-4xl font-bold text-blue mb-4">Need Expert Assistance?</h2>
            <p className="text-darkgray text-lg leading-relaxed max-w-2xl mx-auto">
              Our team of legal and compliance experts is ready to help you navigate complex regulatory requirements and
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-lg font-semibold text-blue mb-2">Legal Expertise</h3>
              <p className="text-darkgray/70 text-sm">Comprehensive legal guidance for your business</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-lg font-semibold text-orange mb-2">24/7 Support</h3>
              <p className="text-darkgray/70 text-sm">Round-the-clock assistance when you need it</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-lg font-semibold text-green-600 mb-2">Dedicated Team</h3>
              <p className="text-darkgray/70 text-sm">Personalized support from our experts</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-lg font-semibold text-purple-600 mb-2">Guaranteed Quality</h3>
              <p className="text-darkgray/70 text-sm">100% satisfaction guaranteed service</p>
            </div>
          </div>
            ...
            <div className="relative">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-center md:text-left">
                  <h3 className="text-2xl font-bold text-blue mb-2">Ready to Get Started?</h3>
                  <p className="text-darkgray">Get expert assistance for your business registration</p>
                </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-darkgray/70 text-sm">
              Join thousands of satisfied businesses that have trusted our expertise
            </p>
          </div>
        </div>
      </div>
