    ...
    <section className="py-16 bg-custom-gradient-page relative overflow-hidden">
      <div className="container mx-auto">
        ...
        <p className="text-center text-darkgray mb-12 max-w-3xl mx-auto">
          Ensure you have all the necessary documents ready for a smooth
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer border border-gray-100">
              ...
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mr-4">
                ...
                >
                  <path
                    ...
                    strokeWidth="2"
                    d="M15 7h3l-4-4-4 4h3v12h2V7z"
                  />
                </svg>
              </div>
              <h3 className="text-2xl font-semibold text-[#FCA229]">
                Identity Proof
              </h3>
            </div>
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <p className="text-darkgray group-hover:text-blue transition-colors duration-300">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer border border-gray-100">
            ...
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <p className="text-darkgray group-hover:text-blue transition-colors duration-300">
                  Registered office address proof (Electricity Bill, Rent
                  Agreement)
                </p>
              </li>
              <li className="flex items-start group">
